...
public class FootballClub {
    ...
    public FootballClub(String clubName, double ticketFee, long balance, String stadium, int studiumCapacity,
                        Player[] players) {
        this.clubName = clubName;
        this.ticketFee = ticketFee;
        this.balance = balance;
        this.stadium = stadium;
        this.studiumCapacity = studiumCapacity;
        this.team = players;
    }
    ...
    public int getStudiumCapacity() {
        return studiumCapacity;
    }
    public void setStudiumCapacity(int studiumCapacity) {
        this.studiumCapacity = studiumCapacity;
    }
    ...
    public void sellTicket(int soldTicketNumber) {
        soldTicketNumber = soldTicketNumber > this.studiumCapacity ? this.studiumCapacity : soldTicketNumber;
